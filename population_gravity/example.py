...
class TestProjectedOutputs:
    ...
    def __init__(self, au, ar, bu, br, kd, rid, state_name, ssp, root_dir, hist_year, start_year, end_year):
        ...
        # self.OUTPUT_DIRECTORY = f'/Users/d3y010/Desktop/sample_out'
    ...
    def run_array1d_outputs(self):
        ...
        run = Model(grid_coordinates_file=self.GRID_COORD_FILE,
                    historical_rural_pop_raster=self.HIST_RURAL_RASTER,
                    historical_urban_pop_raster=self.HIST_URBAN_RASTER,
                    ...
                    projection_start_year=self.start_year,
...
if __name__ == '__main__':
    ...
    ssp = 'ssp2'
    root_dir = '/Users/d3y010/projects/population/testbed'
